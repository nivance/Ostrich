...
public class BlockingConnectionFilter extends BaseFilter {
	...
	public NextAction handleRead(final FilterChainContext ctx)
		...
		if (packet.getPacketType() == PacketType.result
			...
			FutureImpl<JsonPacket> completeFuture = attrSendBuffer
	...
	public JsonPacket write(Connection<?> connection,
			JsonPacket packet) throws IOException, RouterException,
			RemoteCallException {
	...
	public void post(Connection<?> connection, JsonPacket packet)
		...
		try {
			...
			throw new RouterException("remote call timeout");
		}
	}
